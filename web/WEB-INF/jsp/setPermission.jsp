...
----------------------------------------------------------------------------------------------------
Document   : Page displays a list of users allowed to use a given data channel
Created on : Sep 15, 2010, 10:15:39 AM
Author     : szewczenko
--------------------------------------------------------------------------------------------------%>
...
<head>
    ...
    <title>Set channel permissions</title>
</head>
        ...
        <div class="outer">
            <div class="inner">
                <div class="float-wrap">
                    <div id="main">
                        <h1>Set channel permissions</h1>
                        <br/>
                        <h2>
                            <p>
                            Select users allowed to use this channel.
                            </p>
                        </h2>
                        <form method="post">
