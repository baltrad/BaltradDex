        ...
        <div class="routes">
            <div class="table">
                ...
                <div class="header-text">
                    This rule removes files from BDB that are older than age 
                    limit at the time of the execution of this rule. Age limit 
                    is given in seconds. File age is taken from /what/date 
                    and /what/time.
                    <br/><br/>
                    <b>
                    Note that you currently have to separately schedule 
                    this rule.
                    </b>
                </div>
                <form name="createRouteForm" 
                      action="route_create_bdb_trim_age.htm">
                    ...
                    <div class="body">
                        ...
                        <div class="row2">
                            <div class="leftcol">Age limit:</div>
                            <div class="rightcol">
                                <input type="text" name="ageLimit" 
                                       value="${ageLimit}" 
                                       title="Specify maximum age (in seconds) of DB records"/>                                
                            </div>
                        </div>               
                    </div>
