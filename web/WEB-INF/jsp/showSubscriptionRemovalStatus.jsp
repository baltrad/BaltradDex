...
----------------------------------------------------------------------------------------------------
Document   : Confirm subscription removal page
Created on : Aug 19, 2010, 9:20:32 AM
Author     : szewczenko
--------------------------------------------------------------------------------------------------%>
        ...
        <div class="outer">
            <div class="inner">
                <div class="float-wrap">
                    <div id="main">
                        <h1>Subscription removal status</h1>
                        <br/>
                        <h2>
                            <p>
                            <c:choose>
                                ...
                                <c:otherwise>
                                    Selected subscriptions have been removed from the system.
                                </c:otherwise>
                            </c:choose>
                            </p>
                        </h2>
