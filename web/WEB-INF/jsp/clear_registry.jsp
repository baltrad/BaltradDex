...
--------------------------------------------------------------------------------
Document   : Remove data delivery register page.
...
<t:page_tabbed pageTitle="Clear registry" activeTab="settings">
  <jsp:body>
    <div class="left">
        <t:menu_settings/>
    </div>
    <div class="right">
        ...
        <c:choose>
            ...
            <c:otherwise>
                <div class="blttext">
                    Click OK to delete ${number_of_entries} entries
                    from data delivery registry.
                </div>
                <div class="table">
                    <div class="addradar">
                        <div class="tablefooter">
                            <form action="clear_registry_status.htm">
                                <div class="buttons">
                                    <button class="rounded" type="button"
