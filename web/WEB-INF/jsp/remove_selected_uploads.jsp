        ...
        <div class="right">
            ...
            <div class="blttext">
                <div class ="alert">
                    ...
                    <div class="text">
                        <br/>
                        The following peer subscriptions will be permanently 
            ...
            <div class="table">
                <div class="subscriptions">
                    <form action="remove_uploads_status.htm" method="post">
                        ...
                        <c:forEach items="${selected_uploads}" var="sub">
                            <div class="entry">
                        ...
                        <div class="tablefooter">
                            <button class="rounded" type="button"
                                onclick="window.location='remove_uploads.htm'">
                                <span>Back</span>
                            </button>
