...
<t:generic_page pageTitle="Show route">
    <jsp:body>
        <div class="routes">
            <div class="table">
                <div class="header">
                    <div class="row">Show route</div>
                </div>
                <div class="header-text">
                     Delete or modify a scansun routing rule. 
                </div>
                <form name="showRouteForm" action="route_show_scansun.htm">
