...
--------------------------------------------------------------------------------
Document   : Display save user account status
Created on : May 23, 2013, 10:07 AM
Author     : szewczenko
------------------------------------------------------------------------------%>
...
<t:generic_page pageTitle="Save user account">
    <jsp:body>
        <div class="show-radars">
            <div class="table">
                <div class="header">
                    <div class="row">Save user account</div>
                </div>
                <div class="header-text">
                    &nbsp;
                </div>
                <t:message_box msgHeader="Success."
                               msgBody="${user_save_success}"
                               errorHeader="Problems encountered."
                               errorBody="${user_save_error}"/>    
