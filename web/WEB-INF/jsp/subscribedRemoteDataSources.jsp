...
<%
    ...
    List subsStatus = ( List )request.getAttribute( "subscribedDataSources" );
        ...
        <div id="container">
            ...
            <div id="content">
                ...
                <div id="right">
                    <div id="page-title">
                        <div class="left">
                            Remote data source subscription status
                        </div>
                        <div class="right">
                        </div>
                    </div>
                    <c:choose>
                        <c:when test="${subs_status == 1}">
                            <div class="message">
                                ...
                                <div class="text">
                                    Requested remote data sources stations have been successfully
                                    subscribed.
