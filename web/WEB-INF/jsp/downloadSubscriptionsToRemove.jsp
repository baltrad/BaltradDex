            ...
            <div id="bltmain">
                ...
                <div id="tabcontent">
                    ...
                    <div class="right">
                        ...
                        <div class="blttext">
                            Warning: The following subscriptions will be permanently removed
                            from the system.
                        </div>
                        <div class="table">
                            <div class="subscriptions">
                                <form action="downloadSubscriptionsRemovalStatus.htm" method="post">
                                    ...
                                    <div class="tablefooter">
                                        <button class="rounded" type="button"
                                            onclick="window.location='removeDownloadSubscriptions.htm'">
                                            <span>Back</span>
                                        </button>
