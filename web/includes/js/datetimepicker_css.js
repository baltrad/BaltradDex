...
var CalPosOffsetY = 6; //Y position offset relative to calendar icon, can be negative value
...
var MonthYearColor = "#FFFFFF";//"#4C6EB3";//"#C12125"; //"#cc0033"; //Font Color of Month and Year in Calendar header.
var WeekHeadColor = "#429602";//"#18861B"; //var WeekHeadColor="#18861B";//Background Color in Week header.
var SundayColor = "#9ECA6D";//"#C0F64F"; //var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor = "#9ECA6D";//"#C0F64F"; //Background color of Saturday.
var WeekDayColor = "#FFEDA6"; //Background color of weekdays.
var FontColor = "blue"; //color of font in Calendar day cell.
var TodayColor = "#4C7DD4";//"#ffbd35"; //var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#4C7DD4";//"#8DD53C"; //var SelDateColor = "#8DD53C";//Backgrond color of selected date in textbox.
...
var imageFilesPath = "includes/images/";
