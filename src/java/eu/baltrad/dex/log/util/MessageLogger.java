 ...
 * </style>
 * <pre>
 * This class is of interest to you if you want to store messages generated by 
 * your software component in the database.
 * Custom appender implemented in the DEX allows to store messages in 
 * the database. You can also add your own appenders to e.g. save a message to a file.
 *
 * To log a message from your software component using default log appender, 
 * initialize Logger object in the following way:
 * <div id="code">
 ...
 *          {
 *              <span class="key">this</span>.log = 
 *                      MessageLogger.getLogger( MessageLogger.SYS_BEAST );
 *          }
 *
 ...
 *      }
 * </div>
 * Message is passed to LogAppender object, where LogEntry object is created 
