...
/**
 * Implements log entry browse and search functionality.
 *
 ...
 */
@Controller
@RequestMapping("/system_messages.htm")
...
public class LogController {
    ...
    public String setupForm(ModelMap model) throws Exception {
        ...
        model.addAttribute(LOG_ENTRIES_KEY, logManager.load(0, 
    ...
    public String processSubmit(ModelMap model,
        ...
        model.addAttribute(LAST_PAGE_KEY, pages[1]);
        model.addAttribute(CURRENT_PAGE_KEY, pages[2]);
        model.addAttribute(LOG_ENTRIES_KEY, entries);
