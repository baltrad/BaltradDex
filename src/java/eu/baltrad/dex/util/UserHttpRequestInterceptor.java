 ...
 * @since 1.0
 */
public class UserHttpRequestInterceptor extends HandlerInterceptorAdapter {
//------------------------------------------------------------------------------------------ Methods
    /**
    ...
    public boolean preHandle( HttpServletRequest request, HttpServletResponse response,
        ...
        if( ApplicationSecurityManager.getUser( request ) == null ) {
            ...
            return false;
        } else if( !ApplicationSecurityManager.getUserRole( request ).equals( User.ROLE_USER ) &&
                !ApplicationSecurityManager.getUserRole( request ).equals( User.ROLE_PEER ) &&
                !ApplicationSecurityManager.getUserRole( request ).equals( User.ROLE_OPERATOR ) &&
