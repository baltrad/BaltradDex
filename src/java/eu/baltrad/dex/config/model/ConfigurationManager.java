...
//------------------------------------------------------------------------------------------ Methods
    ...
    public AppConfiguration loadAppConf() {
        try {
            ...
            AppConfiguration conf = new AppConfiguration( userProps.getProperty( NODE_NAME_PROP ),
                ...
                userProps.getProperty( EMAIL_PROP ), userProps.getProperty( KEYSTORE_PASS ),
                userProps.getProperty( KEY_ALIAS ) );
            return conf;
        } catch( Exception e ) {
    ...
    public void saveAppConf( AppConfiguration appConf ) throws Exception {
        try {
            ...
            userProps.setProperty( KEYSTORE_PASS, appConf.getKeystorePass() );
            userProps.setProperty( KEY_ALIAS, appConf.getCertAlias() );
            //
