...
public class ConfigurationManager implements IConfigurationManager {
    ...
    /** Organization's unit property */
    private static final String ORG_UNIT_PROP = "organization.unit";
    /** Locality property */
    private static final String ORG_LOCALITY_PROP = "organization.locality";
    /** State property */
    private static final String ORG_STATE_PROP = "organization.state";
    /** Country code property */
    private static final String ORG_COUNTRY_CODE = "organization.country_code";
    /** Time zone property */
    ...
    public AppConfiguration loadAppConf() {
        try {
            ...
            AppConfiguration conf = new AppConfiguration(
                    userProps.getProperty(NODE_NAME_PROP),
                    userProps.getProperty(NODE_ADDRESS_PROP), 
                    userProps.getProperty(NODE_TYPE_PROP), 
                    userProps.getProperty(SOFT_VERSION_PROP), 
                    Integer.parseInt(userProps.getProperty(SO_TIMEOUT_PROP)), 
                    Integer.parseInt(userProps.getProperty(CONN_TIMEOUT_PROP)),
                    userProps.getProperty(WORK_DIR_PROP), 
                    userProps.getProperty(IMAGES_DIR_PROP),
                    userProps.getProperty(THUMBNAILS_DIR_PROP), 
                    userProps.getProperty(ORG_NAME_PROP),
                    userProps.getProperty(ORG_UNIT_PROP), 
                    userProps.getProperty(ORG_LOCALITY_PROP),
                    userProps.getProperty(ORG_STATE_PROP),
                    userProps.getProperty(ORG_COUNTRY_CODE),    
                    userProps.getProperty(TIME_ZONE_PROP),
    ...
    public void saveAppConf( AppConfiguration appConf ) throws Exception {
        try {
            ...
            userProps.setProperty(SO_TIMEOUT_PROP, 
                    Integer.toString(appConf.getSoTimeout()));
            userProps.setProperty(CONN_TIMEOUT_PROP, 
                    Integer.toString(appConf.getConnTimeout()));
            ...
            userProps.setProperty(ORG_NAME_PROP, appConf.getOrgName());
            userProps.setProperty(ORG_UNIT_PROP, appConf.getOrgUnit());
            userProps.setProperty(ORG_LOCALITY_PROP, appConf.getLocality());
            userProps.setProperty(ORG_STATE_PROP, appConf.getState());
            userProps.setProperty(ORG_COUNTRY_CODE, appConf.getCountryCode());
            ...
            FileOutputStream out = new FileOutputStream( 
                    ServletContextUtil.getServletContextPath() + DEX_USER_PROPS);
