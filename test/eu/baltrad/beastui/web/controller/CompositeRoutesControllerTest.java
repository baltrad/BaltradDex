...
public class CompositeRoutesControllerTest extends EasyMockSupport {
  private static interface MethodMocker {
    public String viewCreateRoute(Model model, String name, String author,
        ...
        String areaid, String quantity, Integer interval, Integer timeout, Boolean nominal_timeout, Boolean applygra, Double ZR_A, Double ZR_b, String options, Boolean ignore_malfunc, Boolean ctfilter, 
    ...
    public CompositingRule createRule(String areaid, String quantity, int interval,
        ...
        boolean applygra, double ZR_A, double ZR_b, String options, boolean ignore_malfunc, boolean ctfilter, boolean reprocess_quality, String qitotalField, String jsonFilter);
  }
  ...
  public void setUp() throws Exception {
    ...
    classUnderTest = new CompositeRoutesController() {
      ...
      protected String viewCreateRoute(Model model, String name, String author,
          ...
          String areaid, String quantity, Integer interval, Integer timeout, Boolean nominal_timeout, Integer max_age_limit, Boolean applygra, Double ZR_A, Double ZR_b, String options, Boolean ignore_malfunc, Boolean ctfilter, 
        ...
        return method.viewCreateRoute(model, name, author, active, description, recipients, byscan, pmethod, prodpar, selection_method, areaid, quantity, 
            interval, timeout, nominal_timeout, applygra, ZR_A, ZR_b, options, ignore_malfunc, ctfilter, qitotalField, sources, detectors, quality_control_mode, reprocess_quality, jsonFilter, emessage);
      }
  ...
  public void testCreateRoute_initial() throws Exception {
    ...
    expect(method.viewCreateRoute(model, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null)).andReturn("somestring");
  ...
  public void testCreateRoute() throws Exception {
    ...
    expect(method.createRule("areaid", "VRAD", 30, sources, detectors, 1, 40, true, true, CompositingRule.CAPPI, "500", 0, true, 10.0, 20.0, "factory:any", true, true, false, "se.somewhere", filter)).andReturn(rule);
    ...
    classUnderTest = new CompositeRoutesController() {
      ...
      protected CompositingRule createRule(String areaid, String quantity, int interval,
          ...
          int max_age_limit, boolean applygra, double ZR_A, double ZR_b, String options, boolean ignore_malfunc, boolean ctfilter, boolean reprocess_quality, String qitotalField, String jsonFilter) {
        return method.createRule(areaid, quantity, interval, sources, detectors, quality_control_mode, timeout, nominal_timeout, byscan, pmethod, prodpar, selection_method, applygra, ZR_A, ZR_b, options, ignore_malfunc, ctfilter, reprocess_quality, qitotalField, jsonFilter);
      }
    };
    classUnderTest.setAdaptorManager(adaptorManager);
    classUnderTest.setManager(manager);
    ...
    String result = classUnderTest.createRoute(model, "aname", "author", true, "a description", recipients, true, CompositingRule.CAPPI, "500", 0, "areaid", "VRAD", 30, 40, true, -1, true, 10.0, 20.0, "factory:any", true, true, "se.somewhere", sources, detectors, 1, false, filter);
  ...
  public void testCreateRoute_noName() throws Exception {
    ...
    List<String> recipients = new ArrayList<String>();
    Boolean byscan = Boolean.valueOf(false);
    String pmethod = CompositingRule.CAPPI;
    String prodpar = "500";
    Integer selection_method = Integer.valueOf(0);
    String areaid = "xyz";
    String quantity = "noop";
    Integer interval = 10;
    Integer timeout = 10000;
    Boolean nominal_timeout = false;
    Integer max_age_limit = 60;
    ...
    expect(adaptorManager.getAdaptorNames()).andReturn(adaptors);
    expect(method.viewCreateRoute(model, name, author, active, description, recipients, byscan, pmethod, prodpar, selection_method, areaid, quantity, interval, timeout, nominal_timeout, applygra, ZR_A, ZR_b, options, ignore_malfunc, ctfilter, qitotalField, sources, detectors, quality_control_mode, reprocess_quality, filter, emessage)).andReturn("somestring");
    
    replayAll();
    String result = classUnderTest.createRoute(model, name, author, active, description,
        recipients, byscan, pmethod, prodpar, selection_method, areaid, quantity, interval, timeout, nominal_timeout, max_age_limit, applygra, ZR_A, ZR_b, options, ignore_malfunc, ctfilter, 
  ...
  public void testCreateRoute_noAreaid() throws Exception {
    ...
    replayAll();
    String result = classUnderTest.createRoute(model, name, author, active, description,
        recipients, byscan, pmethod, prodpar, selection_method, areaid, quantity, interval, timeout, nominal_timeout, max_age_limit, applygra, ZR_A, ZR_b, options, ignore_malfunc, ctfilter, qitotalField, sources, detectors, quality_control_mode, reprocess_quality, filter);
  ...
  public void testCreateRoute_pmax() throws Exception {
    ...
    expect(method.createRule("areaid", "quantity", 30, sources, detectors, 1, 40, true, true, CompositingRule.PMAX, "500, 70000.0", 0, true, 10.0, 20.0, "factory:any", true, true, false, "se.somewhere", filter)).andReturn(rule);
    expect(manager.create("aname", "author", true, "a description", recipients, rule)).andReturn(def);
    manager.storeDefinition(def);
    ...
    classUnderTest = new CompositeRoutesController() {
      @Override
      protected CompositingRule createRule(String areaid, String quantity, int interval,
          List<String> sources, List<String> detectors, int quality_control_mode, int timeout, boolean nominal_timeout, boolean byscan, String pmethod, String prodpar, int selection_method, int max_age_limit, boolean applygra, double ZR_A, double ZR_b, String options, boolean ignore_malfunc, boolean ctfilter, boolean reprocess_quality, String qitotalField, String jsonFilter) {
        return method.createRule(areaid, quantity, interval, sources, detectors, quality_control_mode, timeout, nominal_timeout, byscan, pmethod, prodpar, selection_method, applygra, ZR_A, ZR_b, options, ignore_malfunc, ctfilter, reprocess_quality, qitotalField, jsonFilter);
      }
    };
    classUnderTest.setAdaptorManager(adaptorManager);
    ...
    String result = classUnderTest.createRoute(model, "aname", "author", true, "a description", recipients, true, CompositingRule.PMAX, "500, 70000.0", 0, "areaid", "quantity", 30, 40, true, -1, true, 10.0, 20.0, "factory:any", true, true, "se.somewhere", sources, detectors, 1, false, filter);
  ...
  public void testCreateRoute_pmax_2() throws Exception {
    ...
    expect(adaptorManager.getAdaptorNames()).andReturn(adaptors);
    expect(method.createRule("areaid", "quantity", 30, sources, detectors, 1, 40, true, true, CompositingRule.PMAX, "0,1", 0, true, 10.0, 20.0, "factory:any", true, true, false, "se.somewhere", filter)).andReturn(rule);
    expect(manager.create("aname", "author", true, "a description", recipients, rule)).andReturn(def);
    manager.storeDefinition(def);
    ...
    classUnderTest = new CompositeRoutesController() {
      protected CompositingRule createRule(String areaid, String quantity, int interval,
          List<String> sources, List<String> detectors, int quality_control_mode, int timeout, boolean nominal_timeout, boolean byscan, String pmethod, String prodpar, int selection_method, 
          int max_age_limit, boolean applygra, double ZR_A, double ZR_b, String options, boolean ignore_malfunc, boolean ctfilter, boolean reprocess_quality, String qitotal_field, String jsonFilter) {
        return method.createRule(areaid, quantity, interval, sources, detectors, quality_control_mode, timeout, nominal_timeout, byscan, pmethod, prodpar, selection_method, applygra, ZR_A, ZR_b, options, ignore_malfunc, ctfilter, reprocess_quality, qitotal_field, jsonFilter);
      }
    };
    classUnderTest.setAdaptorManager(adaptorManager);
    classUnderTest.setManager(manager);
    ...
    String result = classUnderTest.createRoute(model, "aname", "author", true, "a description", recipients, true, CompositingRule.PMAX, "0,1", 0, "areaid", "quantity", 30, 40, true, -1, true, 10.0, 20.0, "factory:any", true, true, "se.somewhere", sources, detectors, 1, false, filter);
  ...
  public void testCreateRoute_pmax_badprodpar() throws Exception {
    ...
    expect(method.viewCreateRoute(model, "name", "author", true, "description", recipients, false, "pmax", ",500000", 0, "areaid", "quantity", 30, 40, true, true, 10.0, 20.0, "factory:any", false, false, "se.somewhere", sources, detectors, 1, false, filter, emessage)).andReturn("somestring");
    
    replayAll();
    String result = classUnderTest.createRoute(model, "name", "author", true, "description", recipients, false, CompositingRule.PMAX, ",500000", 0, "areaid", "quantity", 30, 40, true, -1, true, 10.0, 20.0, "factory:any", false, false, "se.somewhere", sources, detectors, 1, false, filter);
  ...
  public void testViewCreateRoute() throws Exception {
    ...
    expect(model.addAttribute("max_age_limit", max_age_limit)).andReturn(null);
    ...
    expect(model.addAttribute("options", "factory:any")).andReturn(null);
    ...
    String result = classUnderTest.viewCreateRoute(model, name, author, active, description,
        ...
        max_age_limit, applygra, ZR_A, ZR_b, options, ignore_malfunc, ctfilter, qitotal_field, sources, detectors, quality_control_mode, reprocess_quality, filter, emessage);
  ...
  public void testViewCreateRoute_emessage() throws Exception {
    ...
    expect(model.addAttribute("ZR_A", ZR_A)).andReturn(null);
    expect(model.addAttribute("ZR_b", ZR_b)).andReturn(null);
    expect(model.addAttribute("options", options)).andReturn(null);
    expect(model.addAttribute("ignore_malfunc", ignore_malfunc)).andReturn(null);
    expect(model.addAttribute("ctfilter", ctfilter)).andReturn(null);
    expect(model.addAttribute("qitotal_field", qitotal_field)).andReturn(null);
    expect(model.addAttribute("sources", sources)).andReturn(null);
  ...
  public void testCreateRule() throws Exception {
    ...
    crule.setMaxAgeLimit(maxAgeLimit);
    crule.setApplyGRA(true);
    crule.setZR_A(10.0);
    crule.setZR_b(20.0);
    crule.setOptions("factory:any");
    ...
    CompositingRule result = classUnderTest.createRule("abc", "noop", 1, sources, detectors, 1, 2, true, false, CompositingRule.CAPPI, "500.0", 0, maxAgeLimit, true, 10.0, 20.0, "factory:any", true, true, true, "se.somewhere", filter);
